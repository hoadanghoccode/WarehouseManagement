...
public class ResetPasswordController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String linkReset = "http://localhost:8080/WarehouseManagement/adminresetpassword?token="+token;
        
            TokenResetPassword newTokenReset = new TokenResetPassword(user.getUserId(), token, service.expireDateTime(), false);
        
        //send link to this email
        TokenResetDAO tokenDAO = new TokenResetDAO();
        boolean isInsert = tokenDAO.insertTokenReset(newTokenReset);
        if(!isInsert) {
